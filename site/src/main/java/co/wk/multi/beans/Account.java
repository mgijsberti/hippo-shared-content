...
@HippoEssentialsGenerated(internalName = "wkmulti:account")
@Node(jcrType = "wkmulti:account")
public class Account extends HippoCompound {

    public static final String TYPE = "wkmulti:type";
    public static final String LINK = "wkmulti:link";

    @HippoEssentialsGenerated(internalName = "wkmulti:type")
